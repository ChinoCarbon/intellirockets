			...
			[
				...
				[
					...
					[
						...
						[
							SNew(STextBlock)
							.Text(FText::FromString(TEXT("中近程")))
			...
			[
				...
				[
					...
					[
						...
						[
							SNew(STextBlock)
							.Text(FText::FromString(TEXT("中远程")))
			...
			[
				...
				[
					...
					[
						...
						[
							SNew(STextBlock)
							.Text(FText::FromString(TEXT("旅级以上")))
